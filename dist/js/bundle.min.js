...
document.addEventListener('DOMContentLoaded', () => {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger, ScrollSmoother);
  if (!gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.isTouch) {
    ScrollSmoother.create({
      wrapper: '.wrapper',
      // оболочка, где будет плавный скролл
      content: '.content',
      // контент, который будет "плавать"
      smooth: 1.5,
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.hero-section', {
      opacity: 1
    }, {
      opacity: 0,
      scrollTrigger: {
    ...
    const itemsL = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.gallery__left .gallery__item'); // массив эл-тов
    itemsL.forEach(item => {
    ...
    const itemsR = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.gallery__right .gallery__item');
    itemsR.forEach(item => {
      gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(item, {
        x: 50,
        opacity: 0
